...
void ParticleMeshCreator::importModel(const string& filename,  const string& group) {
...
void ParticleMeshCreator::update() {
	//ps.addForce(0,-0.1,0.3);
	ps.update(0.2);
	
	anim.update();
	
	anim.getPosition("left_hand", &left_hand->position.x);
...
void ParticleMeshCreator::draw(const Mat4& pm, const Mat4& vm) {
...
void ParticleMeshCreator::debugDraw() {
	glColor3f(1,1,1);
	ps.draw();
...
void ParticleMeshCreator::mouseMoved(ofMouseEventArgs& args) {
}

void ParticleMeshCreator::mouseDragged(ofMouseEventArgs& args) {
}

void ParticleMeshCreator::mousePressed(ofMouseEventArgs& args) {
...
void ParticleMeshCreator::mouseReleased(ofMouseEventArgs& args) {
}

// setup the shader
void ParticleMeshCreator::setupShader() {
